        ...
        <section id="about" className="w-full p-5 bg-light flex justify-center relative py-16">
            <div className="containers max-w-screen-2xl w-full flex flex-col gap-12 justify-center">
                <header>
                    ...
                    <p className="title-text text-shadow text-center lg:w-3/4 mx-auto text-2xl lg:text-3xl font-light text-dark">We, RC Home Decor situated at Anisabad, Patna, Bihar, operates in the fields of interior
